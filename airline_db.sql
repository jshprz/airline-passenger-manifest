...
CREATE TABLE `flights_tbl` (
  ...
  CONSTRAINT `flights_tbl_ibfk_1` FOREIGN KEY (`aircraft_id`) REFERENCES `aircrafts_tbl` (`id`) ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `passengers_booking_tbl` (
  ...
  CONSTRAINT `passengers_booking_tbl_ibfk_1` FOREIGN KEY (`flight_id`) REFERENCES `flights_tbl` (`id`) ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
